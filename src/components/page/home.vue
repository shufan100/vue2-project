...
import shanxi from '@/components/echarts/json/sx.json';
export default {
    data() {
        return {
            ...
            myChart.setOption({
                tooltip: {
                    ...
                    position: (point, params, dom, rect, size) => {
                      params = {data:{total:200, ques:8, rate:5, up:true, chagne:2}}
                      $(dom).html(`
                        <div id="plan">
                          ...
                          <span>问题数: ${params.data.ques}</span>
                            ...
                            <span class='${
                                params.data.up ? "active5" : ""
                            }'>较上周: <i class="${
                                      params.data.up ? this.up : this.down
...
                        },
        ...
        getInit2(){
            let reliableEcharts = this.$echarts.init(document.getElementById('reliableEcharts'));            
            reliableEcharts.setOption({
                ...
                legend: {
                    ...
                    formatter: function(name) {
                        let index = 0;
                        let clientlabels = ['正常', '低风险', '高风险', '故障'];
                        let clientcounts = [435,310,234,135];
...
                        },
                      data: [
                          {value: 585, name: '正常',itemStyle:{normal:{color:'#00D9FB'}}},
                          {value: 210, name: '低风险',itemStyle:{normal:{color:'#FFFF00'}}},
                          {value: 234, name: '高风险',itemStyle:{normal:{color:'#FEBE03'}}},
                          {value: 135, name: '故障',itemStyle:{normal:{color:'#FF0000'}}},
                      ]
                    }
                ]
            })
            ...
            let stateEchart = this.$echarts.init(document.getElementById('stateEchart'))
