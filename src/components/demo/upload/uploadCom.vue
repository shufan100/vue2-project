<template>
  <div class="ipUpload">
    <el-upload v-show="!cropperUrl" class="upload-demo" :style="{width:aspectRatio>1.5?'360px':aspectRatio>1?'270px':'202px'}" action="#" :ref="refName" :file-list="fileList" :accept='accept' :limit='limit' :maxSize='maxSize' :drag='drag' :multiple='multiple' :tipTitle='tipTitle'
      :show-file-list="false" :auto-upload="false" :on-exceed="handleExceed" :before-upload="beforeUpload" :on-change="handleChange">
    ...
    <div v-show="cropperUrl" class="upload-demo2" :style="{width:aspectRatio>1.5?'360px':aspectRatio>1?'270px':'202px'}">
      ...
      <div class="uploadfile-text" @click.stop="dialogVisible=true;fileUrlList=[cropperUrl]">查看切图</div>
    ...
    <cut-dialog ref="cutDialog" :show="cutDialog.visible" :aspectRatio='aspectRatio' @sureDialog="changeChoseDialog" @closeDialog="changeChoseDialog" @tailorImgUrl='tailorImgUrl' @clickUploadFile='clickUploadFile'></cut-dialog>
    <!-- 图片预览 -->
